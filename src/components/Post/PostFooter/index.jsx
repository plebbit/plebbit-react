                ...
                <div className={styles.card_footer}>
                  <div className={styles.card_footer_wrap}>
                      ...
                      <>
                        {!hasThumbnail && (post?.content || mediaInfo) ? (
                          <>
                            ...
                            >
                              {showContent ? (
                                <CgCompressLeft className={styles.show_content_icon} />
                              ) : (
                                <CgArrowsExpandLeft className={styles.award_icon} />
                              )}
                            </button>
                    ...
                    <Link to={detailRoute} className={styles.footer_comment}>
                      ...
                      <span className={styles.footer_comment_text}>
                        {commentCount} {type !== 'subPlebbit' && 'comments'}
                      </span>
                    </Link>
                    ...
                    {post?.removed ? (
                      <div className={styles.footer_award}>
                        <button
                          className={styles.card_footer_award_wrap}
                          onClick={() => handleOption({ id: 'approved' })}
                        >
                          <span className={styles.award_icon_wrap}>
          ...
          <div className={styles.mobile_content_footer_wrapper}>
            <div className={styles.mobile_footer_voting_box}>
              <div className={styles.mobile_footer_upvote}>
                {vote === 1 ? (
                  <ImArrowUp className={styles.mobile_voting_icon} />
                ) : (
                  <BiUpvote className={styles.mobile_voting_icon} />
                )}
              </div>
              ...
              <div className={styles.mobile_footer_upvote}>
                {vote === -1 ? (
                  <ImArrowDown className={styles.mobile_voting_icon} />
                ) : (
                  <BiDownvote className={styles.mobile_voting_icon} />
                )}
              </div>
            </div>
